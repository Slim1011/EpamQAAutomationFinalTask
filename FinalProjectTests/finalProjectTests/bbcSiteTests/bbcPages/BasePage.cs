...
namespace FinalProjectTests.finalProjectTests.bbcSiteTests.bbcPages
{
    public class BasePage
    {
        ...
        public void WaitVisibilityOfElement(int timeToWait, IList<IWebElement> elements)
        {
            WebDriverWait wait = new WebDriverWait(driver, TimeSpan.FromSeconds(timeToWait));
        ...
        public void WaitElementIsEnable(int timeToWait, IList<IWebElement> elements)
        {
            WebDriverWait wait = new WebDriverWait(driver, TimeSpan.FromSeconds(timeToWait));
            foreach (var element in elements)
            {
